...
# combined worst case (both attempted: 5 + 15 = 20s) still leaves a comfortable ~10s margin
# under the 30s judge per-request timeout for the optimizer and network overhead.
