...
Requires GROQ_API_KEY and/or GEMINI_API_KEY to be set (loaded from .env). Runs the public samples through
...
def main() -> int:
    if not GROQ_API_KEY and not GEMINI_API_KEY:
        print("Neither GROQ_API_KEY nor GEMINI_API_KEY is set — skipping live LLM smoke test.")
        print("Set at least one in .env to exercise the real interpretation path.")
        return 0
